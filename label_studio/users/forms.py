...
USERNAME_LENGTH_ERR = f'用户名长度不能超过{USERNAME_MAX_LENGTH}个字符'
DISPLAY_NAME_LENGTH_ERR = f'显示名称长度不能超过{DISPLAY_NAME_LENGTH}个字符'
...
class LoginForm(forms.Form):
    ...
    def clean(self, *args, **kwargs):
        ...
        if len(email) >= EMAIL_MAX_LENGTH:
            raise forms.ValidationError('Email 过长')
