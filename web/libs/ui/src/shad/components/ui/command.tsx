...
function CommandInput({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.Input>) {
  ...
  return (
    <div
      ...
      className="flex items-center gap-2 h-6 px-2 m-1 focus-within:border-neutral-border-bold border outline-none border-neutral-border rounded-smaller hover:border-neutral-border-bold box-border"
      ref={ref}
    >
      <IconSearch className="text-neutral-content-subtlest w-4 h-4 flex-none" />
