...
import {AiOutlineNodeExpand,AiOutlineFieldTime,AiOutlineAudio,AiOutlineVideoCamera,AiOutlineFileImage,AiOutlineFileText, AiOutlineFieldString, AiOutlineFieldNumber } from "react-icons/ai";
...
export const ViewColumnTypeShortIcon = (type) => typeNameIconMap[type];
...
export const TabColumn = types
  ...
  .views((self) => ({
    ...
    get icon() {
      switch (self.alias) {
        ...
        case "cancelled_annotations":
          return <IconBanSquare width="20" height="20" style={{ color: "#ff6666"}} />;
        case "total_predictions":
          return <IconSparkSquare width="20" height="20" style={{ color: "#e91ec9" }} />;
    ...
    get readableTypeIcon() {
      return ViewColumnTypeShortIcon(self.currentType);
    },
