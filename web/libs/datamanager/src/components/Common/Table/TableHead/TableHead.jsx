...
import { ViewColumnType, ViewColumnTypeName, ViewColumnTypeShortIcon } from "../../../../stores/Tabs/tab_column";
    ...
    const headContent = (
      <>
        <TableCellContent mod={{ canOrder, disabled: stopInteractions }} mix="th-content">
          {columnTranslations[content] || content }
        </TableCellContent>
