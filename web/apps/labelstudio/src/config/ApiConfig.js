export const API_CONFIG = {
  ...
  endpoints: {
    ...
    // taringing
    trainingPlans: "POST:/plans",


    plans: "GET:/plans",
    createPlan: "POST:/plans",
    getPlan: "GET:/plans/:pk",
    editPlan: "PATCH:/plans/:pk",
    deletePlan: "DELETE:/plans/:pk",
    confirmPlan: "POST:/plans/:pk/confirm",
    cancelPlan: "POST:/plans/:pk/cancel",
    deletePlan: "DELETE:/plans/:pk",
    planRecords: "GET:/plans/:pk/records",
