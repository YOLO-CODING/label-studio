...
export const GeneralSettings = () => {
  ...
  // ];
  const samplings = [
    { value: "Sequential", label: "顺序执行", description: "任务将按照创建顺序依次展示" },
    { value: "Uniform", label: "随机分配", description: "系统会随机分配任务，确保公平性" },
  ];
        ...
        <Block name="settings-wrapper">
          <Form action="updateProject" formData={{ ...project }} params={{ pk: project.id }} onSubmit={updateProject}>
            <Form.Row columnCount={1} rowGap="16px">
              ...
              {/*   </Block> */}
              {/* )} */}
              <RadioGroup name="color" label="项目标识色" size="large" labelProps={{ size: "large" }}>
                {colors.map((color) => (
              ...
              <RadioGroup label="任务分配方式" labelProps={{ size: "large" }} name="sampling" simple>
