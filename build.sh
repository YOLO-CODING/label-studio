...
#DOCKER_REGISTRY_NAMESPACE="tunan-tb"
DOCKER_REGISTRY_HOST="192.168.1.57:5000"
...
function build_docker_image {
  ...
  (cd $folder && docker build -t "$IMAGE_NAME:$BUILT_TAG" .) || \
...
function push_aliyun {
  ...
  push_images "$1" ${DOCKER_REGISTRY_HOST} ${DOCKER_REGISTRY_NAMESPACE} ""
}
